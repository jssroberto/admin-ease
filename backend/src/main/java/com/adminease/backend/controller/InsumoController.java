...
public class InsumoController {
        ...
        @GetMapping
        @Operation(summary = "Get all Insumos", description = "Retrieves a list of all Insumos in the system.")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Insumos retrieved successfully", content = @Content(mediaType = "application/json")),
        ...
        @GetMapping("/search")
        @Operation(summary = "Search Insumos", description = "Search Insumos by name containing the query string")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Insumos found successfully", content = @Content(mediaType = "application/json")),
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Insumo retrieved successfully", content = @Content(mediaType = "application/json")),
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "201", description = "Insumo created successfully", content = @Content(mediaType = "application/json")),
                        @ApiResponse(responseCode = "400", description = "Invalid request data"),
                        @ApiResponse(responseCode = "500", description = "Internal server error")
        })
